...
<head>
    ...
    <link rel="stylesheet" href="{{ url('assets/js/rs-plugin/css/settings.css') }}">

    <link rel="stylesheet" href="{{ url('assets/css/styles.css') }}">


    <script type="text/javascript" src="{{ url('assets/js/modernizr.custom.32033.js') }}"></script>
...
<body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="{{ url('assets/img/freeze/logo.png') }}" style="width:200px" alt="" class="logo">
                        </a>
                    </div>
            ...
            <div class="tp-banner" >
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <!-- MAIN IMAGE -->
                        <img src="{{ url('assets/img/transparent.png') }}"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption lfl fadeout hidden-xs"
                            ...
                            <img src="{{ url('assets/img/freeze/Slides/hand-freeze.png') }}" alt="" style="width:499px!important;height:600px!important">
                        </div>
                        ...
                        <div class="tp-caption lfl fadeout visible-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="{{ url('assets/img/freeze/iphone-freeze.png') }}" alt="">
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption lfb fadeout hidden-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="{{ url('assets/img/freeze/Slides/freeze-slide2.png')}}" alt="">
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="{{ url('assets/img/freeze/Slides/family-freeze.png')}}" alt="">
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4" >
                        <img src="{{ url('assets/img/freeze/iphone-freeze.png')}}" class="img-responsive scrollpoint sp-effect5" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                            <img src="{{ url('assets/img/freeze/freeze-angled2.png')}}" alt="">
                        </div>
                        <div class="platforms">
        ...
        <footer>
            <div class="container">
                <a href="#" class="scrollpoint sp-effect3">
                    <img src="{{ url('assets/img/freeze/logo.png')}}" style="width:222px;heigth:81px;" alt="" class="logo">
                </a>
                <div class="social">
    ...
    <script src="{{ url('assets/js/placeholdem.min.js')}}"></script>
    <script src="{{ url('assets/js/rs-plugin/js/jquery.themepunch.plugins.min.js')}}"></script>
    <script src="{{ url('assets/js/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
